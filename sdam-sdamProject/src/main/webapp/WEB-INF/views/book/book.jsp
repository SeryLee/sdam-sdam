    ...
    <div class="container py-5">
        ...
        <nav aria-label="breadcrumb animated slideInDown">
            <ol class="breadcrumb mb-0">
                <li class="breadcrumb-item"><a class="text-white" href="${root }main">Home &nbsp;/</a></li>
    ...
    <div class="container my-3">
            ...
            <div class="form-check ml-3 text-center">
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" value="대전"
                           name="company_local" id="flexRadioDefault6"
                           <c:if test="${param.company_local eq '대전'}">checked="checked"</c:if>> <label
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" value="경기도"
                           name="company_local" id="flexRadioDefault9"
                           <c:if test="${param.company_local eq '경기도'}">checked="checked"</c:if>>
                    <label class="form-check-label" for="flexRadioDefault9"> 경기도 </label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" value="강원도"
                           name="company_local" id="flexRadioDefault10"
                           <c:if test="${param.company_local eq '강원도'}">checked="checked"</c:if> >
                    <label class="form-check-label" for="flexRadioDefault10"> 강원도 </label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" value="충청도"
                           name="company_local" id="flexRadioDefault11"
                           <c:if test="${param.company_local eq '충청도'}">checked="checked"</c:if>>
                ...
                <div class="row justify-content-center mx-0">
                    <div class="col-lg-10">
                        <div class="card border-0">
                            ...
                            <div class="row w-75 px-5 py-5 mx-auto mb-5 d-inline-block"
                                 style="border: 3px solid #FFCF57;">
                                <h3 class="pt-2 pb-4"><i class="bi bi-calendar-check"></i>&nbsp;&nbsp;&nbsp;날짜·시간 예약안내
                                </h3>
                                <table>
                                    <tr>
                                    ...
                                    <tr>
                                        <td class="col-1 text-center"><p><i class="bi bi-check-lg"></i></td>
                                        <td><p> 테라피독 예약 신청은 10:00 AM부터 17:00 PM까지 가능하며 <strong>최소 1시간에서 최대 3시간</strong>까지
                                            예약할 수 있습니다.</p></td>
                                    </tr>
                                    <tr>
                                        <td class="col-1 text-center"><p><i class="bi bi-exclamation-lg"></i></td>
                                        <td><p> 마지막 신청 시간으로 <strong style="color: #EC9532;">17:00 PM</strong>을 선택한 경우,
                                            당일 테라피독 서비스는 <strong style="color: #EC9532;">18:00 PM</strong>에 종료됩니다.</p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="col-1 text-center"><p><i class="bi bi-check-lg"></i></td>
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-md-10 text-center">
                                            ...
                                            <input type="text" name="service_date"
                                                   class="form-control w-25  mx-auto mb-3" id="result1"
                                                   placeholder="예약 희망일" readonly="readonly">
                                            <div class="col-md-12">
                            ...
                            <div class="btn-group" role="group" aria-label="Basic checkbox toggle button group">
                                <input type="checkbox" value="10:00AM" class="btn-check" id="btncheck1"
                                       name="service_time" autocomplete="off">
                                <label class="btn btn-outline-warning" for="btncheck1">AM 10:00</label>

                                <input type="checkbox" value="11:00AM" class="btn-check" id="btncheck2"
                                       name="service_time" autocomplete="off">
                                <label class="btn btn-outline-warning" for="btncheck2">AM 11:00</label>

                                <input type="checkbox" value="12:00PM" class="btn-check" id="btncheck3"
                                       name="service_time" autocomplete="off">
                                <label class="btn btn-outline-warning" for="btncheck3">PM 12:00</label>

                                <input type="checkbox" value="13:00PM" class="btn-check" id="btncheck4"
                                       name="service_time" autocomplete="off">
                                <label class="btn btn-outline-warning" for="btncheck4">PM 13:00</label>

                                <input type="checkbox" value="14:00PM" class="btn-check" id="btncheck5"
                                       name="service_time" autocomplete="off">
                                <label class="btn btn-outline-warning" for="btncheck5">PM 14:00</label>

                                <input type="checkbox" value="15:00PM" class="btn-check" id="btncheck6"
                                       name="service_time" autocomplete="off">
                                <label class="btn btn-outline-warning" for="btncheck6">PM 15:00</label>

                                <input type="checkbox" value="16:00PM" class="btn-check" id="btncheck7"
                                       name="service_time" autocomplete="off">
                                <label class="btn btn-outline-warning" for="btncheck7">PM 16:00</label>

                                <input type="checkbox" value="17:00PM" class="btn-check" id="btncheck8"
                                       name="service_time" autocomplete="off">
        ...
        <div class="py-5">
            ...
            <div class="d-flex pb-5 wow">
                ...
                <div class="my-1 px-3">
                    <input type="checkbox" value="대형견" class="btn-check" name="dog_tag" id="btnradio1"
                           autocomplete="off">
                    <label class="btn btn-outline-primary" for="btnradio1"># 대형견</label>
                </div>
                <div class="my-1 px-3">
                    <input type="checkbox" value="중형견" class="btn-check" name="dog_tag" id="btnradio2"
                           autocomplete="off">
                    <label class="btn btn-outline-primary" for="btnradio2"># 중형견</label>
                </div>
                <div class="my-1 px-3">
                    <input type="checkbox" value="소형견" class="btn-check" name="dog_tag" id="btnradio3"
                           autocomplete="off">
                ...
                <div class="my-1 px-3">
                    <input type="checkbox" value="활발한" class="btn-check" name="dog_tag" id="btnradio4"
                           autocomplete="off">
                    <label class="btn btn-outline-primary" for="btnradio4"># 활발한</label>
                </div>
                <div class="my-1 px-3">
                    <input type="checkbox" value="조용한" class="btn-check" name="dog_tag" id="btnradio5"
                           autocomplete="off">
                    <label class="btn btn-outline-primary" for="btnradio5"># 조용한</label>
                </div>
                <div class="my-1 px-3">
                    <input type="checkbox" value="애교많은" class="btn-check" name="dog_tag" id="btnradio6"
                           autocomplete="off">
                    <label class="btn btn-outline-primary" for="btnradio6"># 애교많은</label>
                </div>
                <div class="my-1 px-3">
                    <input type="checkbox" value="장난기많은" class="btn-check" name="dog_tag" id="btnradio7"
                           autocomplete="off">
                    <label class="btn btn-outline-primary" for="btnradio7"># 장난기많은</label>
                </div>
                <div class="my-1 ps-3">
                    <input type="checkbox" value="사교적인" class="btn-check" name="dog_tag" id="btnradio8"
                           autocomplete="off">
            ...
            <div class="row row-cols-1 row-cols-md-3 mb-3 text-center" id="showDogs"
        ...
        <div class="text-center mb-5">
            <button type="submit" class="btn btn-primary btn-lg" id="bookSubmit" onclick="return notBook()">신청하기
            </button>
